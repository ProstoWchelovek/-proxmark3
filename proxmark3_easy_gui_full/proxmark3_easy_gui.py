...
- Hex редактор дампов памяти с поддержкой редактирования
- Визуальный редактор скриптов на нодах (Node Editor)
- Визуализация сигналов и графиков
- Умные подсказки и информация о командах
- Безопасность опасных операций
- Система обновлений приложения и прошивки
- Drag & Drop файлов
- Цветные логи с прогресс-барами
- Полная поддержка русского языка
"""

__version__ = "3.0.0"
__author__ = "Proxmark3 Community"
__license__ = "GPL-3.0"
